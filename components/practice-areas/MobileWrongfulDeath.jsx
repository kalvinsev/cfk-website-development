...
export default function MobileWrongfulDeath() {
  return (
    <div>
      <MobileHeaderBar />
      <img
      ...
      >
        ...
        <div style={{ backgroundColor: "#232323", padding: "0 2rem" }}>
          ...
          <p className="mission-statement-paragraph-elements">
            Our law firm has handled wrongful death cases involving car
            accidents where the deceased person’s family was able to seek
            justice on their behalf. The main questions we ask clients about the
          ...
          <p className="mission-statement-paragraph-elements">
            ...
            was a government entity, the statute of limitations is only six
        ...
        <div style={{ backgroundColor: "#232323", padding: "0 2rem" }}>
          ...
          <p className="mission-statement-paragraph-elements">
            ...
            health issues or suicide risk. If an inmate has shown signs of
            mental illness or is at-risk for committing suicide and they are
            neglected by prison staff, the prison could be liable for their
            suicide.
          </p>
          <p
            className="gold-mission-lettering"
          ...
          <p className="mission-statement-paragraph-elements">
            In California, only certain individuals are allowed to file a
            wrongful death claim. The parties that are allowed to bring a
            wrongful death claim are the deceased person’s surviving spouse,
            domestic partner, or surviving children. If no descendent exists, a
            wrongful death claim can be brought by a person who would be
            entitled to the property of the deceased by intestate succession.
            These parties include the parents of the deceased or their siblings,
            depending on who is living at the time. If they can prove financial
            dependence, other individuals who can file a wrongful death claim
            are a putative spouse, their children, or any stepchildren.
          </p>
          ...
          <p className="mission-statement-paragraph-elements">
            ...
            loved one, we recommend collecting as much information about the
            case as you can. Any police reports, medical records, or witness
            contact information will be very helpful for your case.
          </p>
          <p
            className="gold-mission-lettering"
            style={{
          ...
          >
            ...
            able to help you work with insurance companies and bring your case
            to trial if need be.
          </p>
        </div>
      </div>
