...
export default function MobileCriminalLaw() {
  return (
    <div>
      <MobileHeaderBar />
      <img
      ...
      >
        <div style={{ backgroundColor: "#232323", padding: "0 2rem" }}>
          ...
          <p className="mission-statement-paragraph-elements">
            Being convicted of a crime can lead to devastating life
            consequences. You can lose your right to vote, your ability to make
            a living — and even your freedom. In California, the stakes for
            criminal law cases can prove to be even more substantial as a result
            of the “Three Strikes” sentencing law. Our Los Angeles Criminal
            defense attorneys handle misdemeanor, felony and Juvenile cases all
            over California and throughout Los Angeles County, Ventura County,
            San Francisco Bay Area, Orange County and San Diego County. Our team
            of experienced Los Angeles criminal lawyers also handle cases in
            federal court including RICO cases and white-collar criminal
            defense.
          </p>
          <p className="mission-statement-paragraph-elements">
