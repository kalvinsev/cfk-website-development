...
export default function MobileMotorVehicleAccidents() {
  return (
    <div>
      <MobileHeaderBar />
      <img
      ...
      >
        ...
        <div style={{ backgroundColor: "#232323", padding: "0 2rem" }}>
          ...
          <p className="mission-statement-paragraph-elements">
            Always make sure you get the other driver’s information.
          </p>
          <p className="mission-statement-paragraph-elements">
            Take photos of every car in the accident. Even if your car wasn’t
            damaged much, taking photos of the other car(s) could help you in
            the future.
          </p>
          <p className="mission-statement-paragraph-elements">
            If there are witnesses, get their contact info.
          </p>
          <p className="mission-statement-paragraph-elements">
            Get yourself checked out for injuries as soon as possible.
          </p>
          <p className="mission-statement-paragraph-elements">
            If you’re injured, call an accident lawyer. They can give you free
            advice.
          </p>
          <p
            className="gold-mission-lettering"
        ...
        <div style={{ backgroundColor: "#232323", padding: "0 2rem" }}>
          ...
          >
            ...
            always call a lawyer. At Lawyers for the People, we never charge for
